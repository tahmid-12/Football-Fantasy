...
<head>
    ...
    <title>Bundesliga Fixtures</title>
     <link rel="icon" href="image/Sm_logos/bundesliga.jpg">
</head>
<body data-spy="scroll" data-target=".navbar">
    <div class="container-fluid" id="header_container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="leagueLogo">Bundesliga</h1>
            </div>
        </div>
        <br>
        <!--Nav bar-->
    ...
    <div class="tab-pane fade show active match" id="matches" role="tabpanel">
           <!--1-->
            <table class="table table-bordered table-hover">
                <thead>
                    <tr>
                        <th class="table-hover" colspan="2">Matches</th>
                    </tr>
                </thead>
                <tbody>
                <?php
                  $query = "SELECT * FROM  bundesligatable";
    ...
    <div class="tab-pane fade show standing" id="standings" role="tabpanel">
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <?php
                  $query = "SELECT * FROM  bundesligastandings";
    ...
    <div class="tab-pane fade show statistics" id="stats" role="tabpanel">
        ...
        <table class="table table-bordered  table-hover">
            ...
            <tbody>
            <?php
                  $query = "SELECT * FROM  bundesligagoals";
        ...
        <table class="table table-bordered  table-hover">
            ...
            <tbody>
            <?php
                  $query = "SELECT * FROM  bundesligaassists";
        ...
        <table class="table table-bordered  table-hover">
            ...
            <tbody>
            <?php
                  $query = "SELECT * FROM  bundesligayellow";
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
            <?php
                  $query = "SELECT * FROM  bundesligared";
    ...
    <div class="tab-pane fade show player" id="players" role="tabpanel">
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
            <?php
                  $query = "SELECT * FROM  bundesligaplayers";
