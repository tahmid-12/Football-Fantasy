            ...
            <div class="col-md-12">
                <div class="box1">
                   <h1 class="fonts text-center">Player Information</h1>
                    <!--<label class="fonts" style="margin-left:120px;margin-top:50px;" for="t_height">Player Photo<span style="margin-left:45px;">:</span></label>
                    <input type="file" multiple="false" accept="image/*" id="finput" style="margin-left:30px;margin-top:50px;" onchange="readURL(this);">
                    <img id="blah" src="#" alt="your image">
                    -->
                    <br>
                    <form action="BundesligaPlayersConnect.php" method="post">
