                ...
                <div class="box2">
                    <!--Goals-->
                     <div class="goals">
                         ...
                         <form action="BundesligaGoalConnect.php" method="post">
                     ...
                     <div class="assists">
                         ...
                         <form action="BundesligaAssistsConnect.php" method="post">
                         <label class="fonts" style="margin-left:120px;margin-top:50px;" for="t_height">Player Name <span style="margin-left:80px;">:</span></label>
                         <input type="text" id="t_heights" style="margin-left:30px" width="50px;" name="_name">
                         <br>
                     ...
                     <div class="yellowcard">
                         ...
                         <form action="BundesligaYellowConnect.php" method="post">
                         <label class="fonts" style="margin-left:120px;margin-top:50px;" for="t_height">Player Name <span style="margin-left:80px;">:</span></label>
                         <input type="text" id="t_heights" style="margin-left:30px" width="50px;" name="_name">
                         <br>
                     ...
                     <div class="yellowcard">
                         ...
                         <form action="BundesligaRedConnect.php" method="post">
                         <label class="fonts" style="margin-left:120px;margin-top:50px;" for="t_height">Player Name <span style="margin-left:80px;">:</span></label>
                         <input type="text" id="t_heights" style="margin-left:30px" width="50px;" name="_name">
                         <br>
