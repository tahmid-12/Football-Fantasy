...
<body data-spy="scroll" data-target=".navbar">
    <div class="container-fluid" id="header_container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="leagueLogo">Serie A</h1>
            </div>
        </div>
        <br>
        <!--Nav bar-->
    ...
    <div class="tab-pane fade show standing" id="standings" role="tabpanel">
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
            <?php
                  $query = "SELECT * FROM  serieastandings";
    ...
    <div class="tab-pane fade show statistics" id="stats" role="tabpanel">
        ...
        <table class="table table-bordered  table-hover">
            ...
            <tbody>
            <?php
                  $query = "SELECT * FROM  serieaassists";
        ...
        <table class="table table-bordered  table-hover">
            ...
            <tbody>
            <?php
                  $query = "SELECT * FROM  serieayellow";
    ...
    <div class="tab-pane fade show player" id="players" role="tabpanel">
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <?php
                  $query = "SELECT * FROM  serieaplayers";
