                ...
                <div class="box2">
                    <!--Goals-->
                     <div class="goals">
                         ...
                         <form action="serieaGoalsConnect.php" method="post">
                     ...
                     <div class="assists">
                         ...
                         <form action="serieaAssistsConnect.php" method="post">
                         <label class="fonts" style="margin-left:120px;margin-top:50px;" for="t_height">Player Name <span style="margin-left:80px;">:</span></label>
                         <input type="text" id="t_heights" style="margin-left:30px" width="50px;" name="_name">
                         <br>
                     ...
                     <div class="yellowcard">
                         ...
                         <form action="serieaYellowConnect.php" method="post">
                         <label class="fonts" style="margin-left:120px;margin-top:50px;" for="t_height">Player Name <span style="margin-left:80px;">:</span></label>
                         <input type="text" id="t_heights" style="margin-left:30px" width="50px;" name="_name">
                         <br>
                     ...
                     <div class="yellowcard">
                         ...
                         <form action="serieaRedConnect.php" method="post">
                         <label class="fonts" style="margin-left:120px;margin-top:50px;" for="t_height">Player Name <span style="margin-left:80px;">:</span></label>
                         <input type="text" id="t_heights" style="margin-left:30px" width="50px;" name="_name">
                         <br>
