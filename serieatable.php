...
<body style="background-image: url(image/grass.jpg);">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="box1">
                    <form action="SerieATableConnect.php" method="post">
                    ...
                    <img src="image/Sm_logos/seriea.jpg" style="margin-left:300px;" alt="">
                    <br>
                    <label class="fonts" style="margin-left:120px;margin-top:20px;" for="t_height">Away Team <span style="margin-left:80px;">:</span></label>
                    ...
                    <input type="text" id="t_heights" style="margin-left:30px" width="50px;" name="_stadium">
                     ...
                     <br>
                     <input class="btn btn-primary" type="submit" value="Submit" name="submit" style="margin-left:450px;margin-top:30px;width:200px;height:60px;">
                     </form>
                </div>
            </div>
        </div>
